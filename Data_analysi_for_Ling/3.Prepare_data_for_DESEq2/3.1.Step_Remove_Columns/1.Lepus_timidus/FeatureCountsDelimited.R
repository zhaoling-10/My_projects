...
setwd("~/Documents/1.Project_2002674-HARECY/RNA-Seq_Ling/Danilos_pipeline_26-03-2026/2.Step_Remove_Columns/1.Lepus_timidus")
file <- "gene_counts_featureCounts_Exon_Goal_s2_LT.txt"
