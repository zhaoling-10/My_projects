# --------------------------------------------
# src/script/stabilityyyyyyy.R   (NO permutation)
# --------------------------------------------
...
run_stability <- function(data,
  ...
  # -----------------------------
  # Metadata + centratura per genotipo
  # -----------------------------
  ...
  data_gc <- genotype_center(data, meta)  # matrice su cui calcoliamo le correlazioni
  
  # -----------------------------
  # Funzioni core (coerenti con la tua pipeline)
  # -----------------------------
  ...
  # -----------------------------
  # Funzioni per cartografia & switches (mirror al tuo codice)
  # -----------------------------
  apcc_fn <- function(W) {
  ...
  # -----------------------------
  # Subsampling 80% stratificato per genotipo
  # -----------------------------
  ...
  # -----------------------------
  # Consenso switches (≥50% dei run totali)
  # -----------------------------
