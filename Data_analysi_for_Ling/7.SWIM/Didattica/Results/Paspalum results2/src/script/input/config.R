config <- function(){
  ...
  filename_data <- paste0(path,"/matrix/Hola.txt")
  filename_CTRL <- paste0(path,"/list/Pn_diploid.txt")
  filename_CASE <- paste0(path,"/list/Pn_Ploidy.txt")
